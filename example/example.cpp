...
void file_events_example() {
    ...
    handlers.before_open = [](spdlog::filename_t filename) { spdlog::info("Before opening logfile"); };
    ...
    handlers.after_close = [](spdlog::filename_t filename) { spdlog::info("After closing logfile"); };
