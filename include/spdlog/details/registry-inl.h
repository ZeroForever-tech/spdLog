...
SPDLOG_INLINE void registry::register_logger(std::shared_ptr<logger> new_logger) {
    std::lock_guard<spdlog_mutex> lock(logger_map_mutex_);
...
SPDLOG_INLINE void registry::set_tp(std::shared_ptr<thread_pool> tp) {
    std::lock_guard<spdlog_recursive_mutex> lock(tp_mutex_);
    tp_ = std::move(tp);
}
...
SPDLOG_INLINE std::recursive_mutex &registry::tp_mutex() { return tp_mutex_.mtx(); }
